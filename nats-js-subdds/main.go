...
func usage() {
	log.Printf("Usage: nats-js-subdds [-s server] [-creds file] [-nkey file] [-tlscert file] [-tlskey file] [-tlscacert file] <stream> <consumer>\n")
	flag.PrintDefaults()
}
...
func main() {
	...
	sub, err := js.PullSubscribe("", "", nats.Bind(str, con), nats.ManualAck())
